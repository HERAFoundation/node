...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3435fcc465f578c, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f3435fcc465f578c, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "sporechain.sporechain.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "sporechain.sporechain.QueryParamsResponse")
}

func init() { proto.RegisterFile("sporechain/query.proto", fileDescriptor_f3435fcc465f578c) }

var fileDescriptor_f3435fcc465f578c = []byte{
	// 284 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2b, 0x2e, 0xc8, 0x2f,
	0x4a, 0x4d, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x2f, 0x2c, 0x4d, 0x2d, 0xaa, 0xd4, 0x2b, 0x28, 0xca,
	...
	0x00, 0x00, 0xff, 0xff, 0x78, 0x7e, 0x62, 0x4b, 0xe6, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sporechain.sporechain.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sporechain.sporechain.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sporechain.sporechain.Query",
	...
	Metadata: "sporechain/query.proto",
}
