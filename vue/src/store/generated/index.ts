...
import SporechainSporechainSporechain from './sporechain/sporechain.sporechain'
...
export default { 
  ...
  SporechainSporechainSporechain: load(SporechainSporechainSporechain, 'sporechain.sporechain'),
